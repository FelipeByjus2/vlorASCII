...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		{
			numberkey();
			document.getElementById("d1").innerHTML="Você precionou uma tecla número";
		...
		{
			specialkey();
			document.getElementById("d1").innerHTML="Você precionou uma tecla especial (ctrl/alt/esc)";
